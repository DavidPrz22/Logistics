...
import { almacenesQueryOptions, choferesQueryOptions, clientesQueryOptions, divisasQueryOptions, tasasCambioQueryOptions, metodosPagoQueryOptions, motivosRechazoQueryOptions } from './queryOptions';
